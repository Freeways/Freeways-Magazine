...
\FreeChap{SFML.png}{Simple and Fast Multimedia Library}
%\NewsItem{\textcolor[rgb]{0.55,0,0}{\huge Simple and Fast Multimedia Library }}
\vspace*{-60mm}

\parag{\hspace*{6mm} Simple and Fast Multimedia Library (SFML) is a cross-platform software development library designed to provide a simple interface to various multimedia components in computers. However, feel free to call it a 'rendering' engine as well.}
...
\parag{Laurent once wrote: "When I started to write this library in 2006, I couldn't imagine that it would become so much popular. Around 100,000 visitors per month, 100 new forum posts everyday \dots{} this is huge!" - SFML Game Development Book.}
...
\vspace*{-6mm}
\begin{flushright}
\scriptsize \textcolor{GreenTea}{\ding{50}~} Member, Freeways ISI\\
\end{flushright}
}