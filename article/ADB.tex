...
{\footnotesize Exemple l'ancien Path contient \textcolor[rgb]{0.55,0,0}{E:$\backslash$Windows}, il sera \textcolor[rgb]{0.55,0,0}{E:$\backslash$Windows; E:$\backslash$android-sdk-windows$\backslash$platform-tools}}

%
	%\begin{center}
		%%\includegraphics[width=80mm]{adbpath3.jpg}
	%%\includegraphics[width=80mm]{adbpath2.jpg}
	%\includegraphics[width=80mm]{adbpath1.jpg}
	%\end{center}
